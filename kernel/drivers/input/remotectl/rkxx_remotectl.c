...
#define R66_REMOTE //open by rocky for 13 key
#ifdef R66_REMOTE
static struct rkxx_remote_key_table remote_key_table_r66[13] = {
	...
	*/
    ...
    // vol
    {0x28, KEY_VOLUMEDOWN},   // Vol-
    {0x20, KEY_MENU},         // Settings	
    {0x08, KEY_VOLUMEUP},     // Vol+	
};
#endif


static struct rkxx_remote_key_table remote_key_table_r_meige[9] = {
			
    {0x0e,KEY_POWER},        // Power
    {0x1e,388},		 		 // mouse switch
	
    // Control
    {0x4e, KEY_UP},           // Up
    {0xee, KEY_DOWN},         // Down
    {0x2e, KEY_LEFT},         // Left
    {0x6e, KEY_RIGHT},        // Right	
    {0xae, KEY_ENTER},        // Ok
    ...
    // vol
    //{0x28, KEY_VOLUMEDOWN},   // Vol-
    {0x5e, KEY_MENU},         // Settings	
    //{0x08, KEY_VOLUMEUP},     // Vol+	
};

static struct rkxx_remote_key_table remote_key_table_r_box[12] = {
			
    {0x48,KEY_POWER},        // Power
    {0xb0,388},		 		 // mouse switch
	
    // Control
    {0xa0, KEY_UP},           // Up
    {0xd8, KEY_DOWN},         // Down
    {0xe0, KEY_LEFT},         // Left
    {0x90, KEY_RIGHT},        // Right	
    {0x10, KEY_ENTER},        // Ok
    ...
    // vol
    {0x30, KEY_VOLUMEDOWN},   // Vol-
    //{0x5e, KEY_MENU},         // Settings	
    {0x70, KEY_VOLUMEUP},     // Vol+	
};
...
static struct rkxx_remotectl_button remotectl_button[] = 
{
...
#if 0//def MEIGE
    {
       .usercode = 0x8011,
       .nbuttons =  9,
       .key_table = &remote_key_table_r_meige[0],
    },
#endif

#if 0//box elc //modify by rocky for change 13 key 
    {
       .usercode = 0x01fe,
       .nbuttons =  12,
       .key_table = &remote_key_table_r_box[0],
    },
#endif
#if 0
    {  
...
static int remotectl_probe(struct platform_device *pdev)
{
  ...
  error = devm_gpio_request(dev, gpio, "remotectl");
    ...
    //wake_lock(&wake_lock_always);   //mid-icon do not need suspend 
	return 0;
